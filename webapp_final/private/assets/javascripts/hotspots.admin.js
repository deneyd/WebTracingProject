  ...
  data: {
    ...
    modify: {
      ...
      add: function(id) {
        ...
        xhttp.open('GET', `/admins/hotspot/add/${id}`, true);
        xhttp.send();
      },
      remove: function(id) {
        var xhttp = new XMLHttpRequest();
        ...
        xhttp.open('GET', `/admins/hotspot/remove/${id}`, true);
        xhttp.send();
      }
    }
  },
...
// get all venues to modify hotspot
var xhttp = new XMLHttpRequest();
xhttp.onreadystatechange = function() {
  if ((this.readyState == 4) && (this.status == 200)) {
    vm.modify.venues = JSON.parse(this.responseText);
  }
};
xhttp.open('GET', '/admins/get/venuesforhotspot', true);
xhttp.send();
